var callback = {
			...
			users: {
				priv: {
					changeTask: function(arg_string, response, context) {
						...
						if (typeof(callback.api.objects.tasks.priv[task]) == 'undefined') {
					...
					showTasks: function(arg_string, response, context) {
						...
						switch (flag) {
							...
							case 'all':
								...
								break;
							case 'active':
								response.info.toShow = 'active';
								break;
							case 'finished':
								response.info.toShow = 'finished';
								break;
							case 'todo':
	...
	process: function(cmd) {
		...
		//is it yourself?
		else if (callback.api.methods.users.priv[possible_method] || callback.api.methods.users.pub[possible_method] || callback.api.objects.users.priv[possible_method]) {
